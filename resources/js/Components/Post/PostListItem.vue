  ...
  <tr scroll-region>
    ...
    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
      ...
      <button
        @click="toggle"
        type="button"
        :class="[post.published ? 'bg-indigo-600' : 'bg-gray-200']"
      ...
      >
        ...
        <span
          aria-hidden="true"
          :class="[post.published ? 'translate-x-5' : 'translate-x-0']"
    ...
    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
      ...
      >
      <inertia-link
        :href="route('blog.delete', post.id)"
        class="ml-4 text-indigo-600 hover:text-indigo-900"
        >Supprimer</inertia-link
      >
    </td>
  </tr>
</template>
